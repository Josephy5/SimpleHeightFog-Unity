...
<br><br>
Particles Unlit code by Unity Technologies ([Particles.hlsl](https://github.com/Unity-Technologies/Graphics/blob/master/Packages/com.unity.render-pipelines.universal/ShaderLibrary/Particles.hlsl) or in [here](https://github.com/Unity-Technologies/Graphics/tree/master/Packages/com.unity.render-pipelines.universal) within Shader or ShaderLibrary folder, both are located in Unity Technologies' Graphics Repo), used in some of the parts of the shader code. Licensed under Unity's Unity Companion License - See [THIRD PARTY LICENSES](THIRD_PARTY_LICENSES) for details.
